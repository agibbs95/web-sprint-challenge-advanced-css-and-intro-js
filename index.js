...
// console.log(getArtistByIndex(artists,
  /*Your Code Here*/function get20s(array, century) {
  const filtered = []
  for (let i = 0; i < array.length; i++) {
    let birth = array[i].years.substring(0, 4)
    let death = array[i].years.substring(7,11)
    if (birth >= century)
...
function removeArtist(/*Your Code Here*/){
   /*Your Code Here*/function removeArtist(array, index) {
...
function addArtist(/*Your Code Here*/){ array.push(obj)
  return array
}
addArtist(artists, {
  id: 20, 
  ...
  bio: 'sale manager turned web developer.'
})
